...
------------------------------------------------------------------------
myFont :: String
myFont = "xft:FuraMono Nerd Font:pixelsize=15"
...
myLaunchManager = "rofi -combi-modi drun,ssh -theme nord -font 'FuraMono Nerd Font 24' -show combi" -- SelectGrid settings
myScrot :: String
...
myWorkspaces :: [String]
myWorkspaces =  [webWS, termWS, workWS, mediaWS, socialWS, toolsWS, magicWS, privateWS]
------------------------------------------------------------------------
-- Layouts:
--
...
myScratchPads =  [ NS "terminalS" spawnTermS  findTermS  manageTermS    -- Small terminal scratchpad
 ...
 where
    ...
    spawnTermS   = "alacritty -Name Scratchpad:Terminal_Bottom"             -- launch terminal
    ...
    spawnTermB   = "alacritty -name Scratchpad:Terminal_Big"                -- launch terminal
...
myStartupHook = do
    ...
    spawnOnce "setxkbmap -layout us' -option 'grp:alt_shift_toggle, caps: control" -- Set dv keyboard layout, Caps Lock serve as an ESC
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
  -- General
    ...
    , ((modm,                 xK_v         ), spawn "firefox"                                         ) -- Launch Firefox browser
    ]
    ++
